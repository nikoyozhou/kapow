...
<object class="Robot" serializationversion="2">
  ...
  <property name="variables" class="Variables">
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="0">包裹</property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="5">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">C:\Users\Ztm\Desktop\Test1.xls</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="10">
        ...
        <property name="stepAction" class="SetNamedRange">
          <property name="rangeName" class="DesiredElementName">
            <property name="name" class="String" id="11">q</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="ExcelElementFinder">
              ...
              <property name="usage" class="MatchingCellFromRange">
                <property name="matcher" class="ExcelContentMatcher">
                  <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
                    <property name="value" class="String">快递包裹</property>
                  </property>
                </property>
              </property>
            </property>
      ...
      <object class="Transition" serializationversion="3" id="12">
        <property name="name" class="String" id="13">Extract Path</property>
      ...
      <object class="Transition" serializationversion="3" id="15">
        <property name="name" class="String">Extract 包裹</property>
        <property name="stepAction" class="ExtractCell">
          <property name="attributeName" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">包裹</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="ExcelElementFinder">
  ...
  "gizmo":{
    ...
    "block": {
        ...
        "steps": [{
          ...
          "gizmo":{
            ...
            "uri": {
              ...
              "gizmo":{
                "text": { "string": "excel:\/\/C:\\\\Users\\\\Ztm\\\\Desktop\\\\kapow1.xls" }
              }
            }
          }
        },
        {
          ...
          "gizmo":{
            ...
            "uri": {
              ...
              "gizmo":{
                "text": { "string": "https:\/\/inv-veri.chinatax.gov.cn\/index.html" }
              }
            }
          }
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Input '2200172160'" }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "INPUT[id=\"fpdm\"][der_rendered=\"y\"]" }
                              }
                            }
                          }
                        }
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Input '00966973'" }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "INPUT[id=\"fphm\"][der_rendered=\"y\"]" }
                              }
                            }
                          }
                        }
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Input '20180713'" }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "INPUT[id=\"kprq\"][der_rendered=\"y\"]" }
                              }
                            }
                          }
                        }
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Input '585145.76'" }
              }
            },
            "branches": [{
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "INPUT[id=\"kjje\"][der_rendered=\"y\"]" }
                              }
                            }
                          }
                        }
        ...
        },
        {
          ...
          "gizmo":{
            ...
            "uri": {
              ...
              "gizmo":{
                "text": { "string": "ssh:\/\/admin:admin@172.17.3.221" }
              }
            }
          }
        },
      ...
      <object class="Transition" serializationversion="3" id="19">
        ...
        <property name="stepAction" class="LoadPage2">
          <property name="urlProvider" class="kapow.robot.plugin.common.stepaction.urlprovider2.ValueURLProvider2">
            <property name="URL" class="String">https://sz.centanet.com/chengjiao/</property>
          </property>
          <property name="browserConfigurationSpecification" class="BrowserConfigurationSpecificationWebKit" serializationversion="25">
            <property name="ancestorProvider" class="BrowserConfigurationSpecificationAncestorProviderForStep"/>
          </property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">tablerecord-list</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
          ...
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="tagRelation" class="BeforeTagRelation" serializationversion="1">
              <property name="tagName" class="ElementName">
                <property name="name" class="String" id="24">1</property>
              </property>
            </property>
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            ...
            <object class="kapow.robot.plugin.common.stateprocessor.attributeconverter.AttributeConverterEntry" serializationversion="0">
              ...
              <property name="dataConverters" class="DataConverters">
                <element class="Extract2DataConverter">
                  <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
                    <property name="value" class="String">.*(span\[\d?\]).*</property>
                  </property>
                </element>
              </property>
